...
SAFE_AUTO_COMMANDS: dict[str, list[str]] = {
    ...
    "build_client_delivery_manifest": ["python3", "scripts/build_client_delivery_manifest.py"],
    "collect_trial_feedback_template": ["python3", "scripts/collect_trial_feedback.py"],
    "build_trial_issue_queue": ["python3", "scripts/build_trial_issue_queue.py"],
    "build_trial_patch_plan": ["python3", "scripts/build_trial_patch_plan.py"],
    "build_patch_execution_board": ["python3", "scripts/build_patch_execution_board.py"],
    "build_client_release_notes": ["python3", "scripts/build_client_release_notes.py"],
    "build_trial_success_report": ["python3", "scripts/build_trial_success_report.py"],
    "build_client_success_dashboard": ["python3", "scripts/build_client_success_dashboard.py"],
    "package_client_success_delivery": ["python3", "scripts/package_client_success_delivery.py"],
    "verify_client_success_package": ["python3", "scripts/verify_client_success_package.py"],
    "build_client_success_presentation": ["python3", "scripts/build_client_success_presentation.py"],
    "run_release_candidate_audit": ["python3", "scripts/run_release_candidate_audit.py"],
    "run_client_rehearsal": ["python3", "scripts/run_client_rehearsal.py"],
...
def _title_to_safe_key(title: str, category: str) -> str | None:
    ...
    mapping = [
        ...
        ("launch room", "build_client_delivery_manifest"),
        ("client delivery manifest", "build_client_delivery_manifest"),
        ("feedback inbox", "collect_trial_feedback_template"),
        ("trial feedback", "collect_trial_feedback_template"),
        ("issue queue", "build_trial_issue_queue"),
        ("patch plan", "build_trial_patch_plan"),
        ("client response notes", "build_trial_patch_plan"),
        ("feedback triage", "build_trial_patch_plan"),
        ("patch execution", "build_patch_execution_board"),
        ("verification checklist", "build_patch_execution_board"),
        ("client release notes", "build_client_release_notes"),
        ("client update message", "build_client_release_notes"),
        ("trial success report", "build_trial_success_report"),
        ("client trial scorecard", "build_trial_success_report"),
        ("next trial plan", "build_trial_success_report"),
        ("trial analytics", "build_trial_success_report"),
        ("client success dashboard", "build_client_success_dashboard"),
        ("trial closeout", "build_client_success_dashboard"),
        ("operator closeout", "build_client_success_dashboard"),
        ("next engagement", "build_client_success_dashboard"),
        ("success package", "package_client_success_delivery"),
        ("client success package", "package_client_success_delivery"),
        ("success package verification", "verify_client_success_package"),
        ("presentation overview", "build_client_success_presentation"),
        ("what to send client", "package_client_success_delivery"),
        ("trial ops", "build_trial_issue_queue"),
        ("launch audit", "run_release_candidate_audit"),
        ("client rehearsal", "run_client_rehearsal"),
...
def _default_safe_cards() -> list[dict[str, Any]]:
    defaults = [
        ...
        ("build_client_delivery_manifest", "Build Client Delivery Manifest", "build_client_delivery_manifest"),
        ("collect_trial_feedback_template", "Create Trial Feedback Template", "collect_trial_feedback_template"),
        ("build_trial_issue_queue", "Build Trial Issue Queue", "build_trial_issue_queue"),
        ("build_trial_patch_plan", "Build Trial Patch Plan", "build_trial_patch_plan"),
        ("build_patch_execution_board", "Build Patch Execution Board", "build_patch_execution_board"),
        ("build_client_release_notes", "Draft Client Release Notes", "build_client_release_notes"),
        ("build_trial_success_report", "Build Trial Success Report", "build_trial_success_report"),
        ("build_client_success_dashboard", "Build Client Success Dashboard", "build_client_success_dashboard"),
        ("package_client_success_delivery", "Dry Run Client Success Package", "package_client_success_delivery"),
        ("verify_client_success_package", "Verify Client Success Package", "verify_client_success_package"),
        ("build_client_success_presentation", "Build Client Success Presentation Overview", "build_client_success_presentation"),
        ("run_release_candidate_audit", "Run Launch Audit", "run_release_candidate_audit"),
        ("run_client_rehearsal", "Run Client Rehearsal", "run_client_rehearsal"),
