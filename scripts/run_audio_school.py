...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run local read-only Audio School analysis.")
    ...
    print(json.dumps({
        ...
        "preview_dir": report.get("preview_dir"),
        "previews_written": report.get("previews_written"),
