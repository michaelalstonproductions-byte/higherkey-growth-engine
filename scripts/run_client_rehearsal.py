...
def main() -> int:
    ...
    checks = [
        ...
        check("trial_ops_route", bridge_exists(root, "collectTrialFeedback", "feedback:collectTrial") and bridge_exists(root, "buildTrialIssueQueue", "feedback:buildTrialIssueQueue") and bridge_exists(root, "buildTrialPatchPlan", "feedback:buildTrialPatchPlan") and bridge_exists(root, "buildPatchExecutionBoard", "feedback:buildPatchExecutionBoard") and bridge_exists(root, "buildClientReleaseNotes", "feedback:buildClientReleaseNotes") and bridge_exists(root, "buildTrialSuccessReport", "feedback:buildTrialSuccessReport") and bridge_exists(root, "buildClientSuccessDashboard", "feedback:buildClientSuccessDashboard") and bridge_exists(root, "packageClientSuccessDelivery", "feedback:packageClientSuccessDelivery") and bridge_exists(root, "verifyClientSuccessPackage", "feedback:verifyClientSuccessPackage") and bridge_exists(root, "buildClientSuccessPresentation", "feedback:buildClientSuccessPresentation"), "Trial Ops feedback, issue queue, patch plan, patch execution, release notes, trial success report, client success dashboard, success package, package verification, and presentation bridges exist."),
    ...
    next_steps = [
        ...
        "Use Trial Ops to collect local feedback, build the issue queue, draft patch plans, track patch execution, prepare client release notes, build the trial success scorecard, close out the client trial, and package client success materials after client sessions.",
