...
def main() -> int:
    ...
    next_steps = [
        ...
        "Use Trial Ops to collect local feedback, build the issue queue, draft patch plans, track patch execution, prepare client release notes, build the trial success scorecard, and close out the client trial after client sessions.",
